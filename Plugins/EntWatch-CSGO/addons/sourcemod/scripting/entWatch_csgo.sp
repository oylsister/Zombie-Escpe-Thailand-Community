...
enum struct entities
{
	...
	int ent_buttonid;
	int ent_ownerid;
	int ent_mode; // 0 = No iButton, 1 = Spam protection only, 2 = Cooldowns, 3 = Limited uses, 4 = Limited uses with cooldowns, 5 = Cooldowns after multiple uses.
	int ent_uses;
	int ent_maxuses;
	int ent_cooldown;
...
entities entArray[512];

int entArraySize = 512;
char triggerArray[512];
int triggerSize = 512;
...
{
	name         = "entWatch",
	author       = "Prometheum & zaCade. Edits: George & Obus & BotoX & Hikka & DarkerZ[RUS], Supported SM 1.11 by Oylsister",
